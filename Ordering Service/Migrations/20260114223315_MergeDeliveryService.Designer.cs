...
namespace Ordering_Service.Migrations
{
    ...
    [Migration("20260114223315_MergeDeliveryService")]
    partial class MergeDeliveryService
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ordering_Service.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ordering_Service.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ordering_Service.Entities.DeliveryZone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ordering_Service.Entities.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ordering_Service.Entities.CartItem", b =>
                {
                    b.HasOne("Ordering_Service.Entities.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Ordering_Service.Entities.Shipment", b =>
                {
                    b.HasOne("Ordering_Service.Entities.UserAddress", "DeliveryAddress")
                        .WithMany()
